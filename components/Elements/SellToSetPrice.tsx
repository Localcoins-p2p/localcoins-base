...
const SellToSetPrice = ({onNext}:any) => {
  ...
  const [fixedPrice, setFixedPrice] = useState(55.87);
  const [selectedusdt, setSelectedusdt] = useState<any>(USDTDATA[0]);
  const [selectedphp, setSelectedphp] = useState<any>(USDTDATA[0]);

  const handleIncrement = () => setFixedPrice(fixedPrice + 1);
  const handleDecrement = () => setFixedPrice(fixedPrice - 1);
        ...
        <div className="my-4">
          ...
          <div className="flex space-x-6 mt-2">
            <label className="flex items-center">
              ...
              />
              <span className="ml-2 text-[14px] text-[#222222] font-[500]">Fixed</span>
            </label>
            <label className="flex items-center">
              <input
                type="radio"
              ...
              />
              <span className="ml-2 text-[14px] text-[#222222] font-[500]">Floating</span>
            </label>
          </div>
        </div>
