  ...
  return (
    <tr className="border-t py-4 md:py-0 border-gray-700 flex-boxx">
      ...
      <td className=" md:py-4">
        <div className="text-[13px] font-[600] text-[#FFFFFF]"><span className='md:hidden'>available: </span> {available} USDT</div>
        <div className="text-[13px] font-[600] text-[#FFFFFF]"><span className='md:hidden'>Order Limit: </span>{limit}</div>
      </td>
      <td className="md:py-4 py-2">
        <div className="flex  justify-between">
          ...
          {payments.map((payment, index) => (
           ...
           <button className="bg-[#3AA53E] md:hidden text-white text-[16px] font-[600] px-4 py-2 rounded-[5px]">Buy USDT</button>
        </div>
