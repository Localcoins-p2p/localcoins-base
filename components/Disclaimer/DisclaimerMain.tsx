...
const DisclaimerMain = () => {
  ...
  return (
    ...
    <SectionInfo
      ...
      disc={
        <div>
          ...
          <div className="mb-2">
            {' '}
            LocalCoins, its developers, and affiliates shall not be liable
            for any direct, indirect, incidental, or consequential damages
            arising from the use of the platform, including, but not limited
            to, loss of cryptocurrency, errors in smart contracts, or any
            other technical failures.
          </div>
          <div>
            LocalCoins provides its platform "as is" and "as available"
    ...
    <SectionInfo
      ...
      email={<span className='text-white'>Email:<span className='text-[#F3AA05]'>localcoinsp2p@gmail.com</span> </span>}
    />
     <Button/>
